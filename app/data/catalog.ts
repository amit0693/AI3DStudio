...
export const PRODUCTS: Product[] = [
  ...
  { id:"PG-03", slug:"custom-name-desk-sign", name:"Custom Name Desk Sign", collection:"Gifts & Personalization", price:24.99, description:"A layered nameplate sized, colored, and lettered for their space.", material:"PLA", colors:giftColors, productionDays:4, personalized:true, featured:true, badge:"Best seller", status:"launch" },
  { id:"PG-04", slug:"personalized-name-bag-tag", name:"Personalized Name Bag Tag", collection:"Gifts & Personalization", price:7.99, description:"A durable two-color tag for backpacks, luggage, and everyday carry.", material:"PETG", colors:giftColors, productionDays:3, personalized:true, badge:"3 for $17.99", status:"launch" },
  ...
  { id:"PD-02", slug:"propagation-station", name:"Propagation Station with Glass Tubes", collection:"Plants & Decor", price:29.99, description:"A stable three-tube stand for watching new roots take shape.", material:"PETG + glass", colors, productionDays:5, status:"launch" },
  { id:"PD-03", slug:"geometric-planter-trio", name:"Geometric Planter Trio", collection:"Plants & Decor", price:32.99, description:"Three coordinated small planters for succulents and desk plants.", material:"PETG", colors, productionDays:6, status:"launch" },
  { id:"PD-04", slug:"hanging-air-plant-holder", name:"Hanging Air-Plant Holder", collection:"Plants & Decor", price:16.99, description:"A light sculptural cradle designed for small air plants.", material:"PETG", colors, productionDays:3, status:"launch" },
  ...
  { id:"GH-01", slug:"modular-tabletop-token-trays", name:"Modular Tabletop Token Trays", collection:"Gaming & Hobbies", price:18.99, description:"Stackable trays keep shared tokens visible and the table moving.", material:"PLA", colors, productionDays:4, featured:true, status:"launch" },
  ...
  { id:"GH-05", slug:"trading-card-display-stands", name:"Trading-Card Display Stands · Set of 3", collection:"Gaming & Hobbies", price:14.99, description:"Low-profile stands that frame favorite cards without covering them.", material:"PLA", colors, productionDays:3, status:"launch" },
  { id:"GH-06", slug:"universal-board-game-organizer", name:"Universal Board-Game Organizer", collection:"Gaming & Hobbies", price:29.99, description:"Configurable trays for cards, cubes, coins, and common components.", material:"PLA", colors, productionDays:6, status:"launch" },
  ...
  { id:"SE-01", slug:"holiday-ornament", name:"Personalized Holiday Ornament", collection:"Seasonal", price:14.99, description:"A name-and-year keepsake with a choice of modern motifs.", material:"PLA", colors:giftColors, productionDays:3, personalized:true, status:"launch", imageSlug:"personalized-ornament" },
  ...
  { id:"SE-06", slug:"valentine-coordinates-keepsake", name:"Valentine Coordinates Keepsake", collection:"Seasonal", price:19.99, description:"A minimal reminder of where your story began.", material:"PLA", colors:giftColors, productionDays:4, personalized:true, status:"launch", imageSlug:"coordinates-date-keepsake" },
  { id:"SE-07", slug:"family-photo-lithophane", name:"Family Photo Lithophane", collection:"Seasonal", price:34.99, description:"A framed glowing photo gift for Mother’s Day, Father’s Day, or anytime.", material:"PLA", colors:giftColors, productionDays:6, personalized:true, status:"launch", imageSlug:"custom-photo-lithophane-night-light" },
  ...
  { id:"BE-02", slug:"table-number-set", name:"Table Number Set · 1–10", collection:"Business & Events", price:49.99, description:"A coordinated set of modern, highly legible table numbers.", material:"PLA", colors:giftColors, productionDays:7, personalized:true, status:"launch" },
  ...
  { id:"BE-05", slug:"branded-bag-tags", name:"Branded Bag Tags · Set of 25", collection:"Business & Events", price:99, description:"Durable branded tags for teams, events, or customer gifts.", material:"PETG", colors, productionDays:10, personalized:true, status:"launch", imageSlug:"personalized-name-bag-tag" },
