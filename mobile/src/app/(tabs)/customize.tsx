...
const styles = StyleSheet.create({
  segment: { minHeight: 52, flexDirection: 'row', padding: 4, backgroundColor: '#E9E4EF', borderRadius: radius.pill },
  ...
  steps: { backgroundColor: colors.mintPale, padding: spacing.lg },
  cardTitle: { color: colors.ink, fontSize: 20, lineHeight: 25, fontWeight: '900' },
  miniStep: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  miniNumber: { width: 30, height: 30, borderRadius: 15, backgroundColor: colors.orange, alignItems: 'center', justifyContent: 'center' },
  ...
  privacy: { borderColor: colors.forest, backgroundColor: colors.mintPale },
