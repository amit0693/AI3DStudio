...
const styles = StyleSheet.create({
  ...
  how: { backgroundColor: colors.charcoal, borderRadius: radius.lg, padding: spacing.lg, gap: spacing.md },
  ...
  stepNumberText: { color: colors.ink, fontWeight: '900' },
  stepCopy: { flex: 1, gap: 3 }, stepTitle: { color: colors.white, fontWeight: '900', fontSize: 16 }, stepText: { color: '#D7E2D9', lineHeight: 20 },
